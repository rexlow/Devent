        ...
        <View style={[centerEverything, container]}>
          <View style={[centerEverything, textContainer]}>
            <View style={titleContainer}>
              <Text style={[title]}>Update Event</Text>
            </View>
            <View style={descContainer}>
              <Text style={[desc]}>Update your event here</Text>
            </View>
          </View>
          ...
          <ActionButton
            ...
            offsetY={0}
            icon={update}
            onPress={() => this.updateEventHelper()} />
        </View>
      </TouchableWithoutFeedback>
    )
  }
...
export default connect(mapStateToProps, actions)(EditCreatedEvent);
